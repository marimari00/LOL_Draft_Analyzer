...
- Click **"Pick"** or **"Ban"** button
- Pick mode: Blue border, recommendations shown
- Ban mode: Red border, no recommendations
...
Two ways to select:
- **Method A**: Click on a recommendation card (if in Pick mode)
- **Method B**: Search in Champion Selector and click champion
...
2. Check that API is running: `http://localhost:8000/health`
